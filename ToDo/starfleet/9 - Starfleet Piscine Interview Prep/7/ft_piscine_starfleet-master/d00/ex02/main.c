...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n", "jkdhfkjsadhdgf", searchPrice(arts, n, "jkdhfkjsadhdgf"));
	printf("price for the art \'%s\' is %d\n", "New York Hot - New York Cold", searchPrice(arts, n, "New York Hot - New York Cold"));
	printf("price for the art \'%s\' is %d\n", "(wigged man grabbing gagged man)", searchPrice(arts, n, "(wigged man grabbing gagged man)"));
	printf("price for the art \'%s\' is %d\n", "!", searchPrice(arts, n, "!"));
