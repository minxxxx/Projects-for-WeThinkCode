...
int main(void)
{
	...
	dict = dictInit(len);
	while (len--)
		dictInsert(dict, arts[len]->name, arts[len]);
	
    printf("price for the art \'%s\' is %d\n", "Guernica", searchPrice(dict, "Guernica"));
	printf("price for the art \'%s\' is %d\n", "jkdhfkjsadhdgf", searchPrice(dict, "jkdhfkjsadhdgf"));
	printf("price for the art \'%s\' is %d\n", "New York Hot - New York Cold", searchPrice(dict, "New York Hot - New York Cold"));
	printf("price for the art \'%s\' is %d\n", "(wigged man grabbing gagged man)", searchPrice(dict, "(wigged man grabbing gagged man)"));
	printf("price for the art \'%s\' is %d\n", "!", searchPrice(dict, "!"));
